...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keyWo", GoGetter: "KeyWo"},
			_jsii_.MemberProperty{JsiiProperty: "keyWoInput", GoGetter: "KeyWoInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKeyWo", GoMethod: "ResetKeyWo"},
