...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationRunTaskGlobalSettings)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-tfe.organizationRunTaskGlobalSettings.OrganizationRunTaskGlobalSettingsConfig",
		reflect.TypeOf((*OrganizationRunTaskGlobalSettingsConfig)(nil)).Elem(),
	)
}
