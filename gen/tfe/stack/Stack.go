...
func (j *jsiiProxy_Stack) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_Stack) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Stack) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_Stack) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Stack) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Stack) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Stack) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_Stack) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_Stack) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Stack) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Stack) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Stack) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
...
func (j *jsiiProxy_Stack) VcsRepo() StackVcsRepoOutputReference {
	var returns StackVcsRepoOutputReference
	_jsii_.Get(
		j,
		"vcsRepo",
		&returns,
...
func Stack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateStack_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_Stack) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_Stack) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Stack) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_Stack) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_Stack) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_Stack) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_Stack) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_Stack) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_Stack) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_Stack) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_Stack) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Stack) MoveFromId(id *string) {
...
func (s *jsiiProxy_Stack) MoveToId(id *string) {
...
func (s *jsiiProxy_Stack) PutVcsRepo(value *StackVcsRepo) {
	if err := s.validatePutVcsRepoParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_Stack) ResetDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetDescription",
		nil, // no parameters
...
func (s *jsiiProxy_Stack) ResetVcsRepo() {
	_jsii_.InvokeVoid(
		s,
		"resetVcsRepo",
		nil, // no parameters
