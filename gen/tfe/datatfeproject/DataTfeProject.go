...
type jsiiProxy_DataTfeProject struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataTfeProject) AutoDestroyActivityDuration() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfeProject) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataTfeProject) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataTfeProject) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataTfeProject) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataTfeProject) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataTfeProject) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataTfeProject) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataTfeProject) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataTfeProject) Node() constructs.Node {
...
func (j *jsiiProxy_DataTfeProject) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_DataTfeProject) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_DataTfeProject) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataTfeProject) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataTfeProject) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfeProject) WorkspaceIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"workspaceIds",
...
func NewDataTfeProject(scope constructs.Construct, id *string, config *DataTfeProjectConfig) DataTfeProject {
	...
	if err := validateNewDataTfeProjectParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataTfeProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataTfeProject_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataTfeProject_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-tfe.dataTfeProject.DataTfeProject",
...
func (d *jsiiProxy_DataTfeProject) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataTfeProject) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataTfeProject) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataTfeProject) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataTfeProject) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataTfeProject) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataTfeProject) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataTfeProject) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataTfeProject) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataTfeProject) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataTfeProject) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataTfeProject) ToString() *string {
	var returns *string
