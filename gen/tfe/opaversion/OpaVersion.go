...
func (j *jsiiProxy_OpaVersion) BetaInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"betaInput",
...
func (j *jsiiProxy_OpaVersion) Connection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connection",
...
func (j *jsiiProxy_OpaVersion) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_OpaVersion) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_OpaVersion) Deprecated() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deprecated",
...
func (j *jsiiProxy_OpaVersion) DeprecatedInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deprecatedInput",
...
func (j *jsiiProxy_OpaVersion) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_OpaVersion) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_OpaVersion) Official() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"official",
...
func (j *jsiiProxy_OpaVersion) OfficialInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"officialInput",
...
func (j *jsiiProxy_OpaVersion) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_OpaVersion) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_OpaVersion) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpaVersion)SetBeta(val interface{}) {
...
func (j *jsiiProxy_OpaVersion)SetConnection(val interface{}) {
...
func (j *jsiiProxy_OpaVersion)SetCount(val interface{}) {
...
func (j *jsiiProxy_OpaVersion)SetDeprecated(val interface{}) {
...
func (j *jsiiProxy_OpaVersion)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_OpaVersion)SetOfficial(val interface{}) {
...
func (j *jsiiProxy_OpaVersion)SetProvisioners(val *[]interface{}) {
...
func OpaVersion_IsConstruct(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func OpaVersion_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func OpaVersion_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()
...
func (o *jsiiProxy_OpaVersion) AddOverride(path *string, value interface{}) {
...
func (o *jsiiProxy_OpaVersion) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (o *jsiiProxy_OpaVersion) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OpaVersion) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_OpaVersion) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OpaVersion) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OpaVersion) ToHclTerraform() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OpaVersion) ToMetadata() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OpaVersion) ToTerraform() interface{} {
	var returns interface{}
