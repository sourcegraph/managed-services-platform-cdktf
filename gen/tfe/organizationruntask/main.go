...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hmacKeyWo", GoGetter: "HmacKeyWo"},
			_jsii_.MemberProperty{JsiiProperty: "hmacKeyWoInput", GoGetter: "HmacKeyWoInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHmacKeyWo", GoMethod: "ResetHmacKeyWo"},
