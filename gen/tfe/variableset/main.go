...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parentProjectId", GoGetter: "ParentProjectId"},
			_jsii_.MemberProperty{JsiiProperty: "parentProjectIdInput", GoGetter: "ParentProjectIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParentProjectId", GoMethod: "ResetParentProjectId"},
