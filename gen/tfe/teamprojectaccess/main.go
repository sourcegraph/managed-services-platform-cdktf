...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "projectAccessInput", GoGetter: "ProjectAccessInput"},
			_jsii_.MemberProperty{JsiiProperty: "projectId", GoGetter: "ProjectId"},
			_jsii_.MemberProperty{JsiiProperty: "projectIdInput", GoGetter: "ProjectIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putProjectAccess", GoMethod: "PutProjectAccess"},
			_jsii_.MemberMethod{JsiiMethod: "putWorkspaceAccess", GoMethod: "PutWorkspaceAccess"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProjectAccess", GoMethod: "ResetProjectAccess"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVariableSets", GoMethod: "ResetVariableSets"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "locking", GoGetter: "Locking"},
			_jsii_.MemberProperty{JsiiProperty: "lockingInput", GoGetter: "LockingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLocking", GoMethod: "ResetLocking"},
			_jsii_.MemberMethod{JsiiMethod: "resetMove", GoMethod: "ResetMove"},
			_jsii_.MemberMethod{JsiiMethod: "resetRuns", GoMethod: "ResetRuns"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunTasks", GoMethod: "ResetRunTasks"},
			_jsii_.MemberMethod{JsiiMethod: "resetSentinelMocks", GoMethod: "ResetSentinelMocks"},
			_jsii_.MemberMethod{JsiiMethod: "resetStateVersions", GoMethod: "ResetStateVersions"},
