...
import (
	...
	"github.com/sourcegraph/managed-services-platform-cdktf/gen/tfe/datatfevariableset/internal"
)
...
func (j *jsiiProxy_DataTfeVariableSet) ParentProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentProjectId",
...
func (j *jsiiProxy_DataTfeVariableSet) ParentProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfeVariableSet) Priority() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"priority",
...
func (d *jsiiProxy_DataTfeVariableSet) ResetParentProjectId() {
	_jsii_.InvokeVoid(
		d,
		"resetParentProjectId",
		nil, // no parameters
