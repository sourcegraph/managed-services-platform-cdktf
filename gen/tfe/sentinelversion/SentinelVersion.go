...
import (
	...
	"github.com/sourcegraph/managed-services-platform-cdktf/gen/tfe/sentinelversion/internal"
)
...
func (j *jsiiProxy_SentinelVersion) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SentinelVersion) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SentinelVersion) DeprecatedReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deprecatedReason",
...
func (j *jsiiProxy_SentinelVersion) DeprecatedReasonInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SentinelVersion) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SentinelVersion) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SentinelVersion) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SentinelVersion) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SentinelVersion) Node() constructs.Node {
...
func (j *jsiiProxy_SentinelVersion) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SentinelVersion) Sha() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sha",
...
func (j *jsiiProxy_SentinelVersion) ShaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"shaInput",
...
func (j *jsiiProxy_SentinelVersion) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SentinelVersion) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SentinelVersion) Url() *string {
	var returns *string
	_jsii_.Get(
		j,
		"url",
...
func (j *jsiiProxy_SentinelVersion) UrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"urlInput",
...
func (j *jsiiProxy_SentinelVersion) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
func (j *jsiiProxy_SentinelVersion) VersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionInput",
...
func NewSentinelVersion(scope constructs.Construct, id *string, config *SentinelVersionConfig) SentinelVersion {
	...
	if err := validateNewSentinelVersionParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_SentinelVersion{}
...
func SentinelVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSentinelVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SentinelVersion_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-tfe.sentinelVersion.SentinelVersion",
...
func (s *jsiiProxy_SentinelVersion) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SentinelVersion) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelVersion) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SentinelVersion) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SentinelVersion) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SentinelVersion) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SentinelVersion) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SentinelVersion) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SentinelVersion) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SentinelVersion) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SentinelVersion) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelVersion) MoveFromId(id *string) {
...
func (s *jsiiProxy_SentinelVersion) MoveToId(id *string) {
...
func (s *jsiiProxy_SentinelVersion) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SentinelVersion) ResetDeprecated() {
	_jsii_.InvokeVoid(
		s,
		"resetDeprecated",
		nil, // no parameters
...
func (s *jsiiProxy_SentinelVersion) ResetDeprecatedReason() {
	_jsii_.InvokeVoid(
		s,
		"resetDeprecatedReason",
		nil, // no parameters
...
func (s *jsiiProxy_SentinelVersion) ResetEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_SentinelVersion) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SentinelVersion) ToString() *string {
	var returns *string
