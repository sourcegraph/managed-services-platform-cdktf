...
type jsiiProxy_TestVariable struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_TestVariable) Category() *string {
	var returns *string
	_jsii_.Get(
		j,
		"category",
...
func (j *jsiiProxy_TestVariable) CategoryInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"categoryInput",
...
func (j *jsiiProxy_TestVariable) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_TestVariable) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TestVariable) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_TestVariable) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_TestVariable) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_TestVariable) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TestVariable) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TestVariable) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TestVariable) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_TestVariable) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
func (j *jsiiProxy_TestVariable) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TestVariable) ModuleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"moduleName",
...
func (j *jsiiProxy_TestVariable) ModuleNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"moduleNameInput",
...
func (j *jsiiProxy_TestVariable) ModuleProvider() *string {
	var returns *string
	_jsii_.Get(
		j,
		"moduleProvider",
...
func (j *jsiiProxy_TestVariable) ModuleProviderInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"moduleProviderInput",
...
func (j *jsiiProxy_TestVariable) Node() constructs.Node {
...
func (j *jsiiProxy_TestVariable) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_TestVariable) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_TestVariable) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_TestVariable) ReadableValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readableValue",
...
func (j *jsiiProxy_TestVariable) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TestVariable) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TestVariable) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_TestVariable) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func NewTestVariable(scope constructs.Construct, id *string, config *TestVariableConfig) TestVariable {
	...
	if err := validateNewTestVariableParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func TestVariable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTestVariable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func TestVariable_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-tfe.testVariable.TestVariable",
...
func (t *jsiiProxy_TestVariable) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TestVariable) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TestVariable) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (t *jsiiProxy_TestVariable) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (t *jsiiProxy_TestVariable) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (t *jsiiProxy_TestVariable) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (t *jsiiProxy_TestVariable) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (t *jsiiProxy_TestVariable) GetStringAttribute(terraformAttribute *string) *string {
...
func (t *jsiiProxy_TestVariable) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (t *jsiiProxy_TestVariable) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TestVariable) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TestVariable) MoveFromId(id *string) {
...
func (t *jsiiProxy_TestVariable) MoveToId(id *string) {
...
func (t *jsiiProxy_TestVariable) OverrideLogicalId(newLogicalId *string) {
...
func (t *jsiiProxy_TestVariable) ResetDescription() {
	_jsii_.InvokeVoid(
		t,
		"resetDescription",
		nil, // no parameters
...
func (t *jsiiProxy_TestVariable) ResetHcl() {
	_jsii_.InvokeVoid(
		t,
		"resetHcl",
		nil, // no parameters
...
func (t *jsiiProxy_TestVariable) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TestVariable) ResetSensitive() {
	_jsii_.InvokeVoid(
		t,
		"resetSensitive",
		nil, // no parameters
...
func (t *jsiiProxy_TestVariable) ResetValue() {
	_jsii_.InvokeVoid(
		t,
		"resetValue",
		nil, // no parameters
...
func (t *jsiiProxy_TestVariable) ToString() *string {
	var returns *string
