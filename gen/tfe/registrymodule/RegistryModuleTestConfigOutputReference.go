...
func (j *jsiiProxy_RegistryModuleTestConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RegistryModuleTestConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RegistryModuleTestConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RegistryModuleTestConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_RegistryModuleTestConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewRegistryModuleTestConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) RegistryModuleTestConfigOutputReference {
	...
	if err := validateNewRegistryModuleTestConfigOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (r *jsiiProxy_RegistryModuleTestConfigOutputReference) ToString() *string {
	var returns *string
