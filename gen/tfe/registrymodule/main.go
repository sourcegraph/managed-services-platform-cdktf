...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "initialVersionInput", GoGetter: "InitialVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInitialVersion", GoMethod: "ResetInitialVersion"},
