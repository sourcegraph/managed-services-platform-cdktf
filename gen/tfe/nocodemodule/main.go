...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "registryModule", GoGetter: "RegistryModule"},
			_jsii_.MemberProperty{JsiiProperty: "registryModuleInput", GoGetter: "RegistryModuleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVersionPin", GoMethod: "ResetVersionPin"},
