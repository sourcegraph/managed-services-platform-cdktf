...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "policyToolVersionInput", GoGetter: "PolicyToolVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPolicyToolVersion", GoMethod: "ResetPolicyToolVersion"},
