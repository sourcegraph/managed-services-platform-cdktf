...
func WorkspaceRun_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWorkspaceRun_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WorkspaceRun) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorkspaceRun) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WorkspaceRun) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WorkspaceRun) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorkspaceRun) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WorkspaceRun) MoveToId(id *string) {
...
func (w *jsiiProxy_WorkspaceRun) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WorkspaceRun) ToHclTerraform() interface{} {
	var returns interface{}
