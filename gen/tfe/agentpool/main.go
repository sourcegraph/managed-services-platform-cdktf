...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "organizationScoped", GoGetter: "OrganizationScoped"},
			_jsii_.MemberProperty{JsiiProperty: "organizationScopedInput", GoGetter: "OrganizationScopedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOrganizationScoped", GoMethod: "ResetOrganizationScoped"},
