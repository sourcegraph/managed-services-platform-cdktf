...
type jsiiProxy_AuditTrailToken struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AuditTrailToken) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AuditTrailToken) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AuditTrailToken) ExpiredAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expiredAt",
...
func (j *jsiiProxy_AuditTrailToken) ExpiredAtInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expiredAtInput",
...
func (j *jsiiProxy_AuditTrailToken) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuditTrailToken) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuditTrailToken) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuditTrailToken) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuditTrailToken) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuditTrailToken) Node() constructs.Node {
...
func (j *jsiiProxy_AuditTrailToken) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_AuditTrailToken) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_AuditTrailToken) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AuditTrailToken) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AuditTrailToken) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuditTrailToken) Token() *string {
	var returns *string
	_jsii_.Get(
		j,
		"token",
...
func NewAuditTrailToken(scope constructs.Construct, id *string, config *AuditTrailTokenConfig) AuditTrailToken {
	...
	if err := validateNewAuditTrailTokenParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_AuditTrailToken{}
...
func AuditTrailToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAuditTrailToken_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AuditTrailToken_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-tfe.auditTrailToken.AuditTrailToken",
...
func (a *jsiiProxy_AuditTrailToken) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuditTrailToken) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditTrailToken) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AuditTrailToken) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AuditTrailToken) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AuditTrailToken) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AuditTrailToken) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AuditTrailToken) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AuditTrailToken) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AuditTrailToken) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AuditTrailToken) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditTrailToken) MoveFromId(id *string) {
...
func (a *jsiiProxy_AuditTrailToken) MoveToId(id *string) {
...
func (a *jsiiProxy_AuditTrailToken) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AuditTrailToken) ResetExpiredAt() {
	_jsii_.InvokeVoid(
		a,
		"resetExpiredAt",
		nil, // no parameters
...
func (a *jsiiProxy_AuditTrailToken) ResetForceRegenerate() {
	_jsii_.InvokeVoid(
		a,
		"resetForceRegenerate",
		nil, // no parameters
...
func (a *jsiiProxy_AuditTrailToken) ResetOrganization() {
	_jsii_.InvokeVoid(
		a,
		"resetOrganization",
		nil, // no parameters
...
func (a *jsiiProxy_AuditTrailToken) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuditTrailToken) ToString() *string {
	var returns *string
