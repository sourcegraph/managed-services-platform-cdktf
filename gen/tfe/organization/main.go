...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSpeculativePlanManagementEnabled", GoMethod: "ResetSpeculativePlanManagementEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "speculativePlanManagementEnabledInput", GoGetter: "SpeculativePlanManagementEnabledInput"},
