...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RegistryGpgKey)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "asciiArmor", GoGetter: "AsciiArmor"},
			_jsii_.MemberProperty{JsiiProperty: "asciiArmorInput", GoGetter: "AsciiArmorInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-tfe.registryGpgKey.RegistryGpgKeyConfig",
		reflect.TypeOf((*RegistryGpgKeyConfig)(nil)).Elem(),
	)
}
