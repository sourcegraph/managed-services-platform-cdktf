...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsConfig",
		reflect.TypeOf((*DataGoogleBigqueryDatasetsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsDatasets",
		reflect.TypeOf((*DataGoogleBigqueryDatasetsDatasets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsDatasetsList",
