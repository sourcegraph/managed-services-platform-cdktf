...
type AlertRouteEscalationConfigEscalationTargetsEscalationPaths struct {
	...
	Value *AlertRouteEscalationConfigEscalationTargetsEscalationPathsValue `field:"optional" json:"value" yaml:"value"`
}
