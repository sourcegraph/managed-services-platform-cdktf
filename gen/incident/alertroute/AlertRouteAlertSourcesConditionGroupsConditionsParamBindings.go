...
type AlertRouteAlertSourcesConditionGroupsConditionsParamBindings struct {
	...
	Value *AlertRouteAlertSourcesConditionGroupsConditionsParamBindingsValue `field:"optional" json:"value" yaml:"value"`
}
