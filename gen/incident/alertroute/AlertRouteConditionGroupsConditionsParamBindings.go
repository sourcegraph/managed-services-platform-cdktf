...
type AlertRouteConditionGroupsConditionsParamBindings struct {
	...
	Value *AlertRouteConditionGroupsConditionsParamBindingsValue `field:"optional" json:"value" yaml:"value"`
}
