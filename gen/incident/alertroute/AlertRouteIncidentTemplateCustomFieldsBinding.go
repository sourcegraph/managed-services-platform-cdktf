...
type AlertRouteIncidentTemplateCustomFieldsBinding struct {
	...
	Value *AlertRouteIncidentTemplateCustomFieldsBindingValue `field:"optional" json:"value" yaml:"value"`
}
