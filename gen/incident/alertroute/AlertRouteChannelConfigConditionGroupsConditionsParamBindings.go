...
type AlertRouteChannelConfigConditionGroupsConditionsParamBindings struct {
	...
	Value *AlertRouteChannelConfigConditionGroupsConditionsParamBindingsValue `field:"optional" json:"value" yaml:"value"`
}
