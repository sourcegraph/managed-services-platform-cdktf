...
type AlertRouteEscalationConfigEscalationTargetsUsers struct {
	...
	Value *AlertRouteEscalationConfigEscalationTargetsUsersValue `field:"optional" json:"value" yaml:"value"`
}
