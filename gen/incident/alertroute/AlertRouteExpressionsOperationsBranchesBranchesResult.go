...
type AlertRouteExpressionsOperationsBranchesBranchesResult struct {
	...
	Value *AlertRouteExpressionsOperationsBranchesBranchesResultValue `field:"optional" json:"value" yaml:"value"`
}
