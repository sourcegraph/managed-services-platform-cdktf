...
type WorkflowExpressionsOperationsBranchesBranchesResult struct {
	...
	Value *WorkflowExpressionsOperationsBranchesBranchesResultValue `field:"optional" json:"value" yaml:"value"`
}
