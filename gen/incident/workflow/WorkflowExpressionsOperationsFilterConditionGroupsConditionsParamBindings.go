...
type WorkflowExpressionsOperationsFilterConditionGroupsConditionsParamBindings struct {
	...
	Value *WorkflowExpressionsOperationsFilterConditionGroupsConditionsParamBindingsValue `field:"optional" json:"value" yaml:"value"`
}
