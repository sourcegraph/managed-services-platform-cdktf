...
type WorkflowExpressionsOperationsBranchesBranchesConditionGroupsConditionsParamBindings struct {
	...
	Value *WorkflowExpressionsOperationsBranchesBranchesConditionGroupsConditionsParamBindingsValue `field:"optional" json:"value" yaml:"value"`
}
