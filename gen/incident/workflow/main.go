...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "continueOnStepError", GoGetter: "ContinueOnStepError"},
			_jsii_.MemberProperty{JsiiProperty: "continueOnStepErrorInput", GoGetter: "ContinueOnStepErrorInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "includePrivateIncidents", GoGetter: "IncludePrivateIncidents"},
			...
			_jsii_.MemberProperty{JsiiProperty: "onceFor", GoGetter: "OnceFor"},
			_jsii_.MemberProperty{JsiiProperty: "onceForInput", GoGetter: "OnceForInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetShortform", GoMethod: "ResetShortform"},
			_jsii_.MemberProperty{JsiiProperty: "runsOnIncidentModes", GoGetter: "RunsOnIncidentModes"},
			_jsii_.MemberProperty{JsiiProperty: "runsOnIncidentModesInput", GoGetter: "RunsOnIncidentModesInput"},
			_jsii_.MemberProperty{JsiiProperty: "runsOnIncidents", GoGetter: "RunsOnIncidents"},
			_jsii_.MemberProperty{JsiiProperty: "runsOnIncidentsInput", GoGetter: "RunsOnIncidentsInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "conditionsApplyOverDelay", GoGetter: "ConditionsApplyOverDelay"},
			_jsii_.MemberProperty{JsiiProperty: "conditionsApplyOverDelayInput", GoGetter: "ConditionsApplyOverDelayInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "forSeconds", GoGetter: "ForSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "forSecondsInput", GoGetter: "ForSecondsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "forEachInput", GoGetter: "ForEachInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "paramBindingsInput", GoGetter: "ParamBindingsInput"},
			_jsii_.MemberMethod{JsiiMethod: "putParamBindings", GoMethod: "PutParamBindings"},
			_jsii_.MemberMethod{JsiiMethod: "resetForEach", GoMethod: "ResetForEach"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
