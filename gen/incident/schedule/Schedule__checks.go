...
func (s *jsiiProxy_Schedule) validatePutHolidaysPublicConfigParameters(value *ScheduleHolidaysPublicConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (s *jsiiProxy_Schedule) validatePutRotationsParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ScheduleRotations:
		value := value.(*[]*ScheduleRotations)
	...
	case []*ScheduleRotations:
		value_ := value.([]*ScheduleRotations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ScheduleRotations; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Schedule) validateSetTeamIdsParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
