...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "holidaysPublicConfig", GoGetter: "HolidaysPublicConfig"},
			_jsii_.MemberProperty{JsiiProperty: "holidaysPublicConfigInput", GoGetter: "HolidaysPublicConfigInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "rotations", GoGetter: "Rotations"},
			_jsii_.MemberProperty{JsiiProperty: "rotationsInput", GoGetter: "RotationsInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "intervalType", GoGetter: "IntervalType"},
			_jsii_.MemberProperty{JsiiProperty: "intervalTypeInput", GoGetter: "IntervalTypeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "handovers", GoGetter: "Handovers"},
			_jsii_.MemberProperty{JsiiProperty: "handoversInput", GoGetter: "HandoversInput"},
			_jsii_.MemberProperty{JsiiProperty: "handoverStartAt", GoGetter: "HandoverStartAt"},
			_jsii_.MemberProperty{JsiiProperty: "handoverStartAtInput", GoGetter: "HandoverStartAtInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putHandovers", GoMethod: "PutHandovers"},
			_jsii_.MemberMethod{JsiiMethod: "putLayers", GoMethod: "PutLayers"},
			_jsii_.MemberMethod{JsiiMethod: "putWorkingIntervals", GoMethod: "PutWorkingIntervals"},
			_jsii_.MemberMethod{JsiiMethod: "resetEffectiveFrom", GoMethod: "ResetEffectiveFrom"},
			_jsii_.MemberMethod{JsiiMethod: "resetWorkingIntervals", GoMethod: "ResetWorkingIntervals"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
