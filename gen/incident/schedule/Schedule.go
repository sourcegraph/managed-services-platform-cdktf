...
func (j *jsiiProxy_Schedule) HolidaysPublicConfig() ScheduleHolidaysPublicConfigOutputReference {
	var returns ScheduleHolidaysPublicConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Schedule) Rotations() ScheduleRotationsList {
	var returns ScheduleRotationsList
	_jsii_.Get(
		j,
		"rotations",
		&returns,
...
func (j *jsiiProxy_Schedule) TeamIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"teamIds",
...
func (j *jsiiProxy_Schedule) TeamIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"teamIdsInput",
...
func (s *jsiiProxy_Schedule) PutHolidaysPublicConfig(value *ScheduleHolidaysPublicConfig) {
	if err := s.validatePutHolidaysPublicConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_Schedule) ResetHolidaysPublicConfig() {
	_jsii_.InvokeVoid(
		s,
		"resetHolidaysPublicConfig",
		nil, // no parameters
...
func (s *jsiiProxy_Schedule) ResetTeamIds() {
	_jsii_.InvokeVoid(
		s,
		"resetTeamIds",
		nil, // no parameters
