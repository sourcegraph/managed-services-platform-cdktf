...
type EscalationPathPathIfElseThenPathLevel struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.17.0/docs/resources/escalation_path#ack_mode EscalationPath#ack_mode}
	AckMode *string `field:"optional" json:"ackMode" yaml:"ackMode"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.17.0/docs/resources/escalation_path#round_robin_config EscalationPath#round_robin_config}.
	RoundRobinConfig *EscalationPathPathIfElseThenPathLevelRoundRobinConfig `field:"optional" json:"roundRobinConfig" yaml:"roundRobinConfig"`
