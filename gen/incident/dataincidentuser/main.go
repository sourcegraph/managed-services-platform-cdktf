...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSlackUserId", GoMethod: "ResetSlackUserId"},
			_jsii_.MemberProperty{JsiiProperty: "slackUserId", GoGetter: "SlackUserId"},
			_jsii_.MemberProperty{JsiiProperty: "slackUserIdInput", GoGetter: "SlackUserIdInput"},
