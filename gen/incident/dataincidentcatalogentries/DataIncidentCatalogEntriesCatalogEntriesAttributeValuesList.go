...
func (j *jsiiProxy_DataIncidentCatalogEntriesCatalogEntriesAttributeValuesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataIncidentCatalogEntriesCatalogEntriesAttributeValuesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataIncidentCatalogEntriesCatalogEntriesAttributeValuesList {
	_init_.Initialize()
...
func NewDataIncidentCatalogEntriesCatalogEntriesAttributeValuesList_Override(d DataIncidentCatalogEntriesCatalogEntriesAttributeValuesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataIncidentCatalogEntriesCatalogEntriesAttributeValuesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataIncidentCatalogEntriesCatalogEntriesAttributeValuesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIncidentCatalogEntriesCatalogEntriesAttributeValuesList) Resolve(_context cdktf.IResolveContext) interface{} {
