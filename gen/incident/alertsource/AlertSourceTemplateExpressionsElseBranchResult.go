...
type AlertSourceTemplateExpressionsElseBranchResult struct {
	...
	Value *AlertSourceTemplateExpressionsElseBranchResultValue `field:"optional" json:"value" yaml:"value"`
}
