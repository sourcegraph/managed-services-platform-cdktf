...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUseNameAsIdentifier", GoMethod: "ResetUseNameAsIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "sourceRepoUrl", GoGetter: "SourceRepoUrl"},
			_jsii_.MemberProperty{JsiiProperty: "sourceRepoUrlInput", GoGetter: "SourceRepoUrlInput"},
