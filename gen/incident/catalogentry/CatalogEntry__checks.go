...
func (c *jsiiProxy_CatalogEntry) validatePutAttributeValuesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CatalogEntryAttributeValues:
		value := value.(*[]*CatalogEntryAttributeValues)
	...
	case []*CatalogEntryAttributeValues:
		value_ := value.([]*CatalogEntryAttributeValues)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CatalogEntryAttributeValues; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_CatalogEntry) validateSetAliasesParameters(val *[]*string) error {
	if val == nil {
...
func (j *jsiiProxy_CatalogEntry) validateSetCatalogTypeIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CatalogEntry) validateSetExternalIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CatalogEntry) validateSetManagedAttributesParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CatalogEntry) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CatalogEntry) validateSetRankParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
