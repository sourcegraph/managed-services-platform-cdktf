...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backlinkAttribute", GoGetter: "BacklinkAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "backlinkAttributeInput", GoGetter: "BacklinkAttributeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSchemaOnly", GoMethod: "ResetSchemaOnly"},
			_jsii_.MemberProperty{JsiiProperty: "schemaOnly", GoGetter: "SchemaOnly"},
			_jsii_.MemberProperty{JsiiProperty: "schemaOnlyInput", GoGetter: "SchemaOnlyInput"},
