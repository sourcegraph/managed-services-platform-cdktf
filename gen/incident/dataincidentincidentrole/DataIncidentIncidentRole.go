package dataincidentincidentrole
...
import (
	...
	"github.com/sourcegraph/managed-services-platform-cdktf/gen/incident/dataincidentincidentrole/internal"
)
...
func (j *jsiiProxy_DataIncidentIncidentRole) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataIncidentIncidentRole) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataIncidentIncidentRole) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataIncidentIncidentRole) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataIncidentIncidentRole) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataIncidentIncidentRole) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataIncidentIncidentRole) Instructions() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instructions",
...
func (j *jsiiProxy_DataIncidentIncidentRole) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataIncidentIncidentRole) Node() constructs.Node {
...
func (j *jsiiProxy_DataIncidentIncidentRole) Shortform() *string {
	var returns *string
	_jsii_.Get(
		j,
		"shortform",
...
func (j *jsiiProxy_DataIncidentIncidentRole) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataIncidentIncidentRole(scope constructs.Construct, id *string, config *DataIncidentIncidentRoleConfig) DataIncidentIncidentRole {
	...
	if err := validateNewDataIncidentIncidentRoleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
// Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.19.1/docs/data-sources/incident_role incident_incident_role} Data Source.
func NewDataIncidentIncidentRole_Override(d DataIncidentIncidentRole, scope constructs.Construct, id *string, config *DataIncidentIncidentRoleConfig) {
	_init_.Initialize()
...
func DataIncidentIncidentRole_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-incident.dataIncidentIncidentRole.DataIncidentIncidentRole",
...
func (d *jsiiProxy_DataIncidentIncidentRole) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataIncidentIncidentRole) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataIncidentIncidentRole) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataIncidentIncidentRole) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataIncidentIncidentRole) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataIncidentIncidentRole) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataIncidentIncidentRole) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataIncidentIncidentRole) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataIncidentIncidentRole) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataIncidentIncidentRole) ToString() *string {
	var returns *string
