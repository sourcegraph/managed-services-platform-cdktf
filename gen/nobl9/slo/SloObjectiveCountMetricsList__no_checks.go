...
func (s *jsiiProxy_SloObjectiveCountMetricsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_SloObjectiveCountMetricsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_SloObjectiveCountMetricsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
