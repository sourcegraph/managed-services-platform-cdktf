...
func (j *jsiiProxy_SloObjectiveCountMetricsTotalList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
...
func (j *jsiiProxy_SloObjectiveCountMetricsTotalList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_SloObjectiveCountMetricsTotalList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
