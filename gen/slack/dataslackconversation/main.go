...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSlackConversation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-slack.dataSlackConversation.DataSlackConversationConfig",
		reflect.TypeOf((*DataSlackConversationConfig)(nil)).Elem(),
	)
}
