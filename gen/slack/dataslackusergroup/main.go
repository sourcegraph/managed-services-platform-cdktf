...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSlackUsergroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-slack.dataSlackUsergroup.DataSlackUsergroupConfig",
		reflect.TypeOf((*DataSlackUsergroupConfig)(nil)).Elem(),
	)
}
