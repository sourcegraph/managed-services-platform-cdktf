...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloseAlertAfterAll", GoMethod: "ResetCloseAlertAfterAll"},
			_jsii_.MemberMethod{JsiiMethod: "resetCount", GoMethod: "ResetCount"},
			_jsii_.MemberProperty{JsiiProperty: "resetRecipientStates", GoGetter: "ResetRecipientStates"},
			_jsii_.MemberProperty{JsiiProperty: "resetRecipientStatesInput", GoGetter: "ResetRecipientStatesInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetResetRecipientStates", GoMethod: "ResetResetRecipientStates"},
			_jsii_.MemberMethod{JsiiMethod: "resetWaitInterval", GoMethod: "ResetWaitInterval"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "notifyType", GoGetter: "NotifyType"},
			_jsii_.MemberProperty{JsiiProperty: "notifyTypeInput", GoGetter: "NotifyTypeInput"},
			_jsii_.MemberMethod{JsiiMethod: "putRecipient", GoMethod: "PutRecipient"},
