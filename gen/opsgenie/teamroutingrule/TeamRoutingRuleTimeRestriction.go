...
type TeamRoutingRuleTimeRestriction struct {
	...
	// restriction block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.35/docs/resources/team_routing_rule#restriction TeamRoutingRule#restriction}
	Restriction *TeamRoutingRuleTimeRestrictionRestriction `field:"optional" json:"restriction" yaml:"restriction"`
	// restrictions block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.35/docs/resources/team_routing_rule#restrictions TeamRoutingRule#restrictions}
