...
// Represents a {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.37/docs/resources/heartbeat opsgenie_heartbeat}.
...
func Heartbeat_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateHeartbeat_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_Heartbeat) AddMoveTarget(moveTarget *string) {
...
func (h *jsiiProxy_Heartbeat) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (h *jsiiProxy_Heartbeat) MoveFromId(id *string) {
...
func (h *jsiiProxy_Heartbeat) MoveToId(id *string) {
