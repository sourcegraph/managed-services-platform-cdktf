...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "impactedServices", GoGetter: "ImpactedServices"},
			_jsii_.MemberProperty{JsiiProperty: "impactedServicesInput", GoGetter: "ImpactedServicesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImpactedServices", GoMethod: "ResetImpactedServices"},
