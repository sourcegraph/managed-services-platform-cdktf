...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "participant", GoGetter: "Participant"},
			_jsii_.MemberProperty{JsiiProperty: "participantInput", GoGetter: "ParticipantInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putParticipant", GoMethod: "PutParticipant"},
