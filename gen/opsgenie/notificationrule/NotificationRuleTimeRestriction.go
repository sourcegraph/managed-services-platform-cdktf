...
type NotificationRuleTimeRestriction struct {
	...
	// restriction block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.37/docs/resources/notification_rule#restriction NotificationRule#restriction}
