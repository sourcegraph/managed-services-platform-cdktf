...
func (e *jsiiProxy_EscalationRulesRecipientList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_EscalationRulesRecipientList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*EscalationRulesRecipient:
		val := val.(*[]*EscalationRulesRecipient)
	...
	case []*EscalationRulesRecipient:
		val_ := val.([]*EscalationRulesRecipient)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*EscalationRulesRecipient; received %#v (a %T)", val, val)
		}
	}
