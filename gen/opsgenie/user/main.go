...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putUserAddress", GoMethod: "PutUserAddress"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocale", GoMethod: "ResetLocale"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSkypeUsername", GoMethod: "ResetSkypeUsername"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimezone", GoMethod: "ResetTimezone"},
			_jsii_.MemberMethod{JsiiMethod: "resetUserAddress", GoMethod: "ResetUserAddress"},
			_jsii_.MemberMethod{JsiiMethod: "resetUserDetails", GoMethod: "ResetUserDetails"},
			_jsii_.MemberProperty{JsiiProperty: "role", GoGetter: "Role"},
			_jsii_.MemberProperty{JsiiProperty: "roleInput", GoGetter: "RoleInput"},
			_jsii_.MemberProperty{JsiiProperty: "skypeUsername", GoGetter: "SkypeUsername"},
			_jsii_.MemberProperty{JsiiProperty: "skypeUsernameInput", GoGetter: "SkypeUsernameInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "userAddress", GoGetter: "UserAddress"},
			_jsii_.MemberProperty{JsiiProperty: "userAddressInput", GoGetter: "UserAddressInput"},
			_jsii_.MemberProperty{JsiiProperty: "userDetails", GoGetter: "UserDetails"},
			_jsii_.MemberProperty{JsiiProperty: "userDetailsInput", GoGetter: "UserDetailsInput"},
