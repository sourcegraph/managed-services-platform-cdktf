...
import (
	...
	"github.com/sourcegraph/managed-services-platform-cdktf/gen/opsgenie/schedule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.35/docs/resources/schedule opsgenie_schedule}.
...
func (j *jsiiProxy_Schedule) OwnerTeamId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerTeamId",
...
func (j *jsiiProxy_Schedule) OwnerTeamIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerTeamIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.35/docs/resources/schedule opsgenie_schedule} Resource.
...
func (s *jsiiProxy_Schedule) ResetEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_Schedule) ResetOwnerTeamId() {
	_jsii_.InvokeVoid(
		s,
		"resetOwnerTeamId",
		nil, // no parameters
...
func (s *jsiiProxy_Schedule) ResetTimezone() {
	_jsii_.InvokeVoid(
		s,
		"resetTimezone",
		nil, // no parameters
