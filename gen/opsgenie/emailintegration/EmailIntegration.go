...
func EmailIntegration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEmailIntegration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmailIntegration) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmailIntegration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EmailIntegration) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmailIntegration) MoveToId(id *string) {
