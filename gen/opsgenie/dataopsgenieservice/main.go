...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpsgenieService)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opsgenie.dataOpsgenieService.DataOpsgenieServiceConfig",
		reflect.TypeOf((*DataOpsgenieServiceConfig)(nil)).Elem(),
	)
}
