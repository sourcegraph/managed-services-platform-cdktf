...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "incidentRule", GoGetter: "IncidentRule"},
			_jsii_.MemberProperty{JsiiProperty: "incidentRuleInput", GoGetter: "IncidentRuleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putIncidentRule", GoMethod: "PutIncidentRule"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putStakeholderProperties", GoMethod: "PutStakeholderProperties"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetDetails", GoMethod: "ResetDetails"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "stakeholderProperties", GoGetter: "StakeholderProperties"},
			_jsii_.MemberProperty{JsiiProperty: "stakeholderPropertiesInput", GoGetter: "StakeholderPropertiesInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "conditionMatchType", GoGetter: "ConditionMatchType"},
			_jsii_.MemberProperty{JsiiProperty: "conditionMatchTypeInput", GoGetter: "ConditionMatchTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "incidentProperties", GoGetter: "IncidentProperties"},
			_jsii_.MemberProperty{JsiiProperty: "incidentPropertiesInput", GoGetter: "IncidentPropertiesInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putConditions", GoMethod: "PutConditions"},
			_jsii_.MemberMethod{JsiiMethod: "putIncidentProperties", GoMethod: "PutIncidentProperties"},
			_jsii_.MemberMethod{JsiiMethod: "resetConditionMatchType", GoMethod: "ResetConditionMatchType"},
