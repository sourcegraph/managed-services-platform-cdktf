...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSentryProject)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-sentry.dataSentryProject.DataSentryProjectConfig",
		reflect.TypeOf((*DataSentryProjectConfig)(nil)).Elem(),
	)
}
