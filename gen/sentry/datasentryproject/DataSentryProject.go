...
// Represents a {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.5/docs/data-sources/project sentry_project}.
...
type jsiiProxy_DataSentryProject struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataSentryProject) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataSentryProject) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataSentryProject) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataSentryProject) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataSentryProject) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataSentryProject) IsPublic() cdktf.IResolvable {
...
func (j *jsiiProxy_DataSentryProject) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataSentryProject) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_DataSentryProject) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_DataSentryProject) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataSentryProject) Slug() *string {
	var returns *string
	_jsii_.Get(
		j,
		"slug",
...
func (j *jsiiProxy_DataSentryProject) SlugInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"slugInput",
...
func (j *jsiiProxy_DataSentryProject) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataSentryProject) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataSentryProject(scope constructs.Construct, id *string, config *DataSentryProjectConfig) DataSentryProject {
	...
	if err := validateNewDataSentryProjectParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataSentryProject{}
...
func DataSentryProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataSentryProject_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataSentryProject_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-sentry.dataSentryProject.DataSentryProject",
...
func (d *jsiiProxy_DataSentryProject) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSentryProject) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataSentryProject) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataSentryProject) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataSentryProject) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataSentryProject) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataSentryProject) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataSentryProject) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataSentryProject) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSentryProject) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataSentryProject) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataSentryProject) ToString() *string {
	var returns *string
