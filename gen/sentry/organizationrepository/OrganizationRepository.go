...
type jsiiProxy_OrganizationRepository struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_OrganizationRepository) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_OrganizationRepository) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_OrganizationRepository) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OrganizationRepository) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OrganizationRepository) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_OrganizationRepository) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_OrganizationRepository) Identifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identifier",
...
func (j *jsiiProxy_OrganizationRepository) IdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identifierInput",
...
func (j *jsiiProxy_OrganizationRepository) IntegrationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationId",
...
func (j *jsiiProxy_OrganizationRepository) IntegrationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationIdInput",
...
func (j *jsiiProxy_OrganizationRepository) IntegrationType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationType",
...
func (j *jsiiProxy_OrganizationRepository) IntegrationTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OrganizationRepository) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrganizationRepository) Node() constructs.Node {
...
func (j *jsiiProxy_OrganizationRepository) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_OrganizationRepository) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_OrganizationRepository) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_OrganizationRepository) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_OrganizationRepository) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewOrganizationRepository(scope constructs.Construct, id *string, config *OrganizationRepositoryConfig) OrganizationRepository {
	...
	if err := validateNewOrganizationRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OrganizationRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOrganizationRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func OrganizationRepository_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-sentry.organizationRepository.OrganizationRepository",
...
func (o *jsiiProxy_OrganizationRepository) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrganizationRepository) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrganizationRepository) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (o *jsiiProxy_OrganizationRepository) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (o *jsiiProxy_OrganizationRepository) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (o *jsiiProxy_OrganizationRepository) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (o *jsiiProxy_OrganizationRepository) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (o *jsiiProxy_OrganizationRepository) GetStringAttribute(terraformAttribute *string) *string {
...
func (o *jsiiProxy_OrganizationRepository) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (o *jsiiProxy_OrganizationRepository) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationRepository) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrganizationRepository) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrganizationRepository) MoveToId(id *string) {
...
func (o *jsiiProxy_OrganizationRepository) OverrideLogicalId(newLogicalId *string) {
...
func (o *jsiiProxy_OrganizationRepository) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		o,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationRepository) ToString() *string {
	var returns *string
