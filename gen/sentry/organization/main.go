...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "agreeTerms", GoGetter: "AgreeTerms"},
			_jsii_.MemberProperty{JsiiProperty: "agreeTermsInput", GoGetter: "AgreeTermsInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-sentry.organization.OrganizationConfig",
