...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationCodeMapping)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSourceRoot", GoMethod: "ResetSourceRoot"},
			_jsii_.MemberMethod{JsiiMethod: "resetStackRoot", GoMethod: "ResetStackRoot"},
			_jsii_.MemberProperty{JsiiProperty: "sourceRoot", GoGetter: "SourceRoot"},
			_jsii_.MemberProperty{JsiiProperty: "sourceRootInput", GoGetter: "SourceRootInput"},
			_jsii_.MemberProperty{JsiiProperty: "stackRoot", GoGetter: "StackRoot"},
			_jsii_.MemberProperty{JsiiProperty: "stackRootInput", GoGetter: "StackRootInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-sentry.organizationCodeMapping.OrganizationCodeMappingConfig",
		reflect.TypeOf((*OrganizationCodeMappingConfig)(nil)).Elem(),
	)
}
