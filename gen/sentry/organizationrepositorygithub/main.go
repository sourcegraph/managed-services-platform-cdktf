...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationRepositoryGithub)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-sentry.organizationRepositoryGithub.OrganizationRepositoryGithubConfig",
		reflect.TypeOf((*OrganizationRepositoryGithubConfig)(nil)).Elem(),
	)
}
