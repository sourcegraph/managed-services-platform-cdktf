...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectSpikeProtection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-sentry.projectSpikeProtection.ProjectSpikeProtectionConfig",
		reflect.TypeOf((*ProjectSpikeProtectionConfig)(nil)).Elem(),
	)
}
