...
// Represents a {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.3/docs/resources/notification_action sentry_notification_action}.
...
// Create a new {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.3/docs/resources/notification_action sentry_notification_action} Resource.
...
func NotificationAction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateNotificationAction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NotificationAction) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NotificationAction) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NotificationAction) MoveFromId(id *string) {
...
func (n *jsiiProxy_NotificationAction) MoveToId(id *string) {
