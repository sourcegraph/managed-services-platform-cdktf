...
type DashboardWidgetOutputReference interface {
	...
	Layout() DashboardWidgetLayoutOutputReference
	LayoutInput() *DashboardWidgetLayout
	Limit() *float64
...
func (j *jsiiProxy_DashboardWidgetOutputReference) DisplayType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayType",
...
func (j *jsiiProxy_DashboardWidgetOutputReference) DisplayTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayTypeInput",
...
func (j *jsiiProxy_DashboardWidgetOutputReference) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DashboardWidgetOutputReference) Interval() *string {
	var returns *string
	_jsii_.Get(
		j,
		"interval",
...
func (j *jsiiProxy_DashboardWidgetOutputReference) IntervalInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"intervalInput",
...
func (j *jsiiProxy_DashboardWidgetOutputReference) Layout() DashboardWidgetLayoutOutputReference {
	var returns DashboardWidgetLayoutOutputReference
	_jsii_.Get(
		j,
		"layout",
		&returns,
...
func (j *jsiiProxy_DashboardWidgetOutputReference) LayoutInput() *DashboardWidgetLayout {
...
func (j *jsiiProxy_DashboardWidgetOutputReference) Query() DashboardWidgetQueryList {
	var returns DashboardWidgetQueryList
	_jsii_.Get(
		j,
		"query",
		&returns,
...
func (j *jsiiProxy_DashboardWidgetOutputReference) WidgetType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"widgetType",
...
func (j *jsiiProxy_DashboardWidgetOutputReference) WidgetTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"widgetTypeInput",
...
func (d *jsiiProxy_DashboardWidgetOutputReference) PutLayout(value *DashboardWidgetLayout) {
	if err := d.validatePutLayoutParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DashboardWidgetOutputReference) ResetInterval() {
	_jsii_.InvokeVoid(
		d,
		"resetInterval",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetOutputReference) ResetWidgetType() {
	_jsii_.InvokeVoid(
		d,
		"resetWidgetType",
		nil, // no parameters
