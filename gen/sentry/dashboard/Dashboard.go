...
// Represents a {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.5/docs/resources/dashboard sentry_dashboard}.
...
func (j *jsiiProxy_Dashboard) InternalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"internalId",
...
func (j *jsiiProxy_Dashboard) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_Dashboard) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
// Create a new {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.5/docs/resources/dashboard sentry_dashboard} Resource.
...
func (j *jsiiProxy_Dashboard)SetOrganization(val *string) {
