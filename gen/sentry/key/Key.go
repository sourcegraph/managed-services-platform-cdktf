...
func Key_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_Key) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_Key) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_Key) MoveFromId(id *string) {
...
func (k *jsiiProxy_Key) MoveToId(id *string) {
