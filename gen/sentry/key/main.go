...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dsn", GoGetter: "Dsn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "javascriptLoaderScript", GoGetter: "JavascriptLoaderScript"},
			_jsii_.MemberProperty{JsiiProperty: "javascriptLoaderScriptInput", GoGetter: "JavascriptLoaderScriptInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putJavascriptLoaderScript", GoMethod: "PutJavascriptLoaderScript"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetJavascriptLoaderScript", GoMethod: "ResetJavascriptLoaderScript"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "debugEnabled", GoGetter: "DebugEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "debugEnabledInput", GoGetter: "DebugEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "performanceMonitoringEnabled", GoGetter: "PerformanceMonitoringEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "performanceMonitoringEnabledInput", GoGetter: "PerformanceMonitoringEnabledInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetBrowserSdkVersion", GoMethod: "ResetBrowserSdkVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetDebugEnabled", GoMethod: "ResetDebugEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetPerformanceMonitoringEnabled", GoMethod: "ResetPerformanceMonitoringEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetSessionReplayEnabled", GoMethod: "ResetSessionReplayEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sessionReplayEnabled", GoGetter: "SessionReplayEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "sessionReplayEnabledInput", GoGetter: "SessionReplayEnabledInput"},
