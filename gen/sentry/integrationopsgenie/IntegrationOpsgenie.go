...
type jsiiProxy_IntegrationOpsgenie struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_IntegrationOpsgenie) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IntegrationOpsgenie) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IntegrationOpsgenie) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IntegrationOpsgenie) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IntegrationOpsgenie) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IntegrationOpsgenie) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IntegrationOpsgenie) IntegrationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationId",
...
func (j *jsiiProxy_IntegrationOpsgenie) IntegrationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationIdInput",
...
func (j *jsiiProxy_IntegrationOpsgenie) IntegrationKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationKey",
...
func (j *jsiiProxy_IntegrationOpsgenie) IntegrationKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationKeyInput",
...
func (j *jsiiProxy_IntegrationOpsgenie) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IntegrationOpsgenie) Node() constructs.Node {
...
func (j *jsiiProxy_IntegrationOpsgenie) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_IntegrationOpsgenie) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_IntegrationOpsgenie) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IntegrationOpsgenie) Team() *string {
	var returns *string
	_jsii_.Get(
		j,
		"team",
...
func (j *jsiiProxy_IntegrationOpsgenie) TeamInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"teamInput",
...
func (j *jsiiProxy_IntegrationOpsgenie) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IntegrationOpsgenie) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewIntegrationOpsgenie(scope constructs.Construct, id *string, config *IntegrationOpsgenieConfig) IntegrationOpsgenie {
	...
	if err := validateNewIntegrationOpsgenieParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IntegrationOpsgenie_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIntegrationOpsgenie_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IntegrationOpsgenie_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-sentry.integrationOpsgenie.IntegrationOpsgenie",
...
func (i *jsiiProxy_IntegrationOpsgenie) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IntegrationOpsgenie) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IntegrationOpsgenie) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IntegrationOpsgenie) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationOpsgenie) MoveFromId(id *string) {
...
func (i *jsiiProxy_IntegrationOpsgenie) MoveToId(id *string) {
...
func (i *jsiiProxy_IntegrationOpsgenie) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IntegrationOpsgenie) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationOpsgenie) ToString() *string {
	var returns *string
