...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSubfilters", GoMethod: "ResetSubfilters"},
			_jsii_.MemberProperty{JsiiProperty: "subfilters", GoGetter: "Subfilters"},
			_jsii_.MemberProperty{JsiiProperty: "subfiltersInput", GoGetter: "SubfiltersInput"},
