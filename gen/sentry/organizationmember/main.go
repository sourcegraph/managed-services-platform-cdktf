...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationMember)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pending", GoGetter: "Pending"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-sentry.organizationMember.OrganizationMemberConfig",
		reflect.TypeOf((*OrganizationMemberConfig)(nil)).Elem(),
	)
}
