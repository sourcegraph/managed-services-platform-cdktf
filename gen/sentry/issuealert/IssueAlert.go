...
// Represents a {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.5/docs/resources/issue_alert sentry_issue_alert}.
...
func IssueAlert_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIssueAlert_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IssueAlert) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IssueAlert) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IssueAlert) MoveFromId(id *string) {
...
func (i *jsiiProxy_IssueAlert) MoveToId(id *string) {
