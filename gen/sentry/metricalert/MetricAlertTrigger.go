...
type MetricAlertTrigger struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jianyuan/sentry/0.12.1/docs/resources/metric_alert#alert_threshold MetricAlert#alert_threshold}.
	AlertThreshold *float64 `field:"required" json:"alertThreshold" yaml:"alertThreshold"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jianyuan/sentry/0.12.1/docs/resources/metric_alert#label MetricAlert#label}.
	...
	// action block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jianyuan/sentry/0.12.1/docs/resources/metric_alert#action MetricAlert#action}
