...
type MetricAlertTrigger struct {
	// action block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.3/docs/resources/metric_alert#action MetricAlert#action}
	Action interface{} `field:"required" json:"action" yaml:"action"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.3/docs/resources/metric_alert#alert_threshold MetricAlert#alert_threshold}.
	AlertThreshold *float64 `field:"required" json:"alertThreshold" yaml:"alertThreshold"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.3/docs/resources/metric_alert#label MetricAlert#label}.
