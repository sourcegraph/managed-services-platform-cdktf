...
// Represents a {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.3/docs/resources/team sentry_team}.
type Team interface {
...
func (j *jsiiProxy_Team) HasAccess() cdktf.IResolvable {
...
func (j *jsiiProxy_Team) InternalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"internalId",
...
func (j *jsiiProxy_Team) IsMember() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"isMember",
...
func (j *jsiiProxy_Team) IsPending() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"isPending",
...
func (j *jsiiProxy_Team) SlugInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"slugInput",
...
// Create a new {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.3/docs/resources/team sentry_team} Resource.
...
func (t *jsiiProxy_Team) ResetSlug() {
	_jsii_.InvokeVoid(
		t,
		"resetSlug",
		nil, // no parameters
