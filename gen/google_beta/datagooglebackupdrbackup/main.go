...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackups",
		reflect.TypeOf((*DataGoogleBackupDrBackupBackups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupConfig",
