...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableLogicalView.GoogleBigtableLogicalViewConfig",
		reflect.TypeOf((*GoogleBigtableLogicalViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeouts",
		reflect.TypeOf((*GoogleBigtableLogicalViewTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeoutsOutputReference",
