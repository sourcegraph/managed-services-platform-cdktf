...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleDataprocMetastoreTableIamPolicy.GoogleDataprocMetastoreTableIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataprocMetastoreTableIamPolicy.GoogleDataprocMetastoreTableIamPolicyConfig",
