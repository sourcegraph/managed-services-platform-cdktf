...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeImageIamMember.GoogleComputeImageIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeImageIamMember.GoogleComputeImageIamMemberCondition",
		reflect.TypeOf((*GoogleComputeImageIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeImageIamMember.GoogleComputeImageIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeImageIamMember.GoogleComputeImageIamMemberConfig",
