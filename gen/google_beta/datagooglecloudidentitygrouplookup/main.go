...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleCloudIdentityGroupLookup.DataGoogleCloudIdentityGroupLookup",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleCloudIdentityGroupLookup.DataGoogleCloudIdentityGroupLookupConfig",
		reflect.TypeOf((*DataGoogleCloudIdentityGroupLookupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleCloudIdentityGroupLookup.DataGoogleCloudIdentityGroupLookupGroupKey",
		reflect.TypeOf((*DataGoogleCloudIdentityGroupLookupGroupKey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleCloudIdentityGroupLookup.DataGoogleCloudIdentityGroupLookupGroupKeyOutputReference",
