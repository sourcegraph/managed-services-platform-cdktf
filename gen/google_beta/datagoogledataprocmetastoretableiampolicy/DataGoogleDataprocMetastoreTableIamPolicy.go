...
import (
	...
	"github.com/sourcegraph/managed-services-platform-cdktf/gen/google_beta/datagoogledataprocmetastoretableiampolicy/internal"
)
...
func NewDataGoogleDataprocMetastoreTableIamPolicy(scope constructs.Construct, id *string, config *DataGoogleDataprocMetastoreTableIamPolicyConfig) DataGoogleDataprocMetastoreTableIamPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-google_beta.dataGoogleDataprocMetastoreTableIamPolicy.DataGoogleDataprocMetastoreTableIamPolicy",
