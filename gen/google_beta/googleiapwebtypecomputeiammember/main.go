...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleIapWebTypeComputeIamMember.GoogleIapWebTypeComputeIamMemberCondition",
		reflect.TypeOf((*GoogleIapWebTypeComputeIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleIapWebTypeComputeIamMember.GoogleIapWebTypeComputeIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleIapWebTypeComputeIamMember.GoogleIapWebTypeComputeIamMemberConfig",
