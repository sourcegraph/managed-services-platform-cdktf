...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceDirectoryEndpoint.GoogleServiceDirectoryEndpointConfig",
		reflect.TypeOf((*GoogleServiceDirectoryEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceDirectoryEndpoint.GoogleServiceDirectoryEndpointTimeouts",
		reflect.TypeOf((*GoogleServiceDirectoryEndpointTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleServiceDirectoryEndpoint.GoogleServiceDirectoryEndpointTimeoutsOutputReference",
