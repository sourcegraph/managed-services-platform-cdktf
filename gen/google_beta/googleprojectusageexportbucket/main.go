...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucket",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketConfig",
		reflect.TypeOf((*GoogleProjectUsageExportBucketConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeouts",
		reflect.TypeOf((*GoogleProjectUsageExportBucketTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeoutsOutputReference",
