...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleOrganizationIamPolicy.DataGoogleOrganizationIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleOrganizationIamPolicy.DataGoogleOrganizationIamPolicyConfig",
