...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleNetworkServicesGateway.GoogleNetworkServicesGatewayConfig",
		reflect.TypeOf((*GoogleNetworkServicesGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleNetworkServicesGateway.GoogleNetworkServicesGatewayTimeouts",
