...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigtableMaterializedView.GoogleBigtableMaterializedView",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableMaterializedView.GoogleBigtableMaterializedViewConfig",
		reflect.TypeOf((*GoogleBigtableMaterializedViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableMaterializedView.GoogleBigtableMaterializedViewTimeouts",
		reflect.TypeOf((*GoogleBigtableMaterializedViewTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigtableMaterializedView.GoogleBigtableMaterializedViewTimeoutsOutputReference",
