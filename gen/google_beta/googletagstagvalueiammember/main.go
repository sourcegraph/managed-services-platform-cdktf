...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleTagsTagValueIamMember.GoogleTagsTagValueIamMemberCondition",
		reflect.TypeOf((*GoogleTagsTagValueIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleTagsTagValueIamMember.GoogleTagsTagValueIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleTagsTagValueIamMember.GoogleTagsTagValueIamMemberConfig",
