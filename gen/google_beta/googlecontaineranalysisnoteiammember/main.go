...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleContainerAnalysisNoteIamMember.GoogleContainerAnalysisNoteIamMemberCondition",
		reflect.TypeOf((*GoogleContainerAnalysisNoteIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleContainerAnalysisNoteIamMember.GoogleContainerAnalysisNoteIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleContainerAnalysisNoteIamMember.GoogleContainerAnalysisNoteIamMemberConfig",
