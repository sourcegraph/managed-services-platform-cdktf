...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleOrganizationIamMember.GoogleOrganizationIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleOrganizationIamMember.GoogleOrganizationIamMemberCondition",
		reflect.TypeOf((*GoogleOrganizationIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleOrganizationIamMember.GoogleOrganizationIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleOrganizationIamMember.GoogleOrganizationIamMemberConfig",
