...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleLustreInstance.GoogleLustreInstanceConfig",
		reflect.TypeOf((*GoogleLustreInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleLustreInstance.GoogleLustreInstanceTimeouts",
