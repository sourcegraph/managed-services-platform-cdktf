...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataplexAspectType.GoogleDataplexAspectTypeConfig",
		reflect.TypeOf((*GoogleDataplexAspectTypeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataplexAspectType.GoogleDataplexAspectTypeTimeouts",
