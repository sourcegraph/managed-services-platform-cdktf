...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberCondition",
		reflect.TypeOf((*GoogleHealthcareDatasetIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberConfig",
