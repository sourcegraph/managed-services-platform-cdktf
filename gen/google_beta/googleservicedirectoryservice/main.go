...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceDirectoryService.GoogleServiceDirectoryServiceConfig",
		reflect.TypeOf((*GoogleServiceDirectoryServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceDirectoryService.GoogleServiceDirectoryServiceTimeouts",
		reflect.TypeOf((*GoogleServiceDirectoryServiceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleServiceDirectoryService.GoogleServiceDirectoryServiceTimeoutsOutputReference",
