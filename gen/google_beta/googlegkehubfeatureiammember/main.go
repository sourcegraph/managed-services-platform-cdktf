...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamMember.GoogleGkeHubFeatureIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamMember.GoogleGkeHubFeatureIamMemberCondition",
		reflect.TypeOf((*GoogleGkeHubFeatureIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamMember.GoogleGkeHubFeatureIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamMember.GoogleGkeHubFeatureIamMemberConfig",
