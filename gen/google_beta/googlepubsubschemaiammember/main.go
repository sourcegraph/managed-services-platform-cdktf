...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googlePubsubSchemaIamMember.GooglePubsubSchemaIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googlePubsubSchemaIamMember.GooglePubsubSchemaIamMemberCondition",
		reflect.TypeOf((*GooglePubsubSchemaIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googlePubsubSchemaIamMember.GooglePubsubSchemaIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googlePubsubSchemaIamMember.GooglePubsubSchemaIamMemberConfig",
