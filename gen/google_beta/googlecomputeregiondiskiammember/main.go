...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeRegionDiskIamMember.GoogleComputeRegionDiskIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeRegionDiskIamMember.GoogleComputeRegionDiskIamMemberCondition",
		reflect.TypeOf((*GoogleComputeRegionDiskIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeRegionDiskIamMember.GoogleComputeRegionDiskIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeRegionDiskIamMember.GoogleComputeRegionDiskIamMemberConfig",
