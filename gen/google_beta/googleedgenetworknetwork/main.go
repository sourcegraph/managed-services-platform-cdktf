...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleEdgenetworkNetwork.GoogleEdgenetworkNetworkConfig",
		reflect.TypeOf((*GoogleEdgenetworkNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleEdgenetworkNetwork.GoogleEdgenetworkNetworkTimeouts",
		reflect.TypeOf((*GoogleEdgenetworkNetworkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleEdgenetworkNetwork.GoogleEdgenetworkNetworkTimeoutsOutputReference",
