...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleIapWebIamMember.GoogleIapWebIamMemberCondition",
		reflect.TypeOf((*GoogleIapWebIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleIapWebIamMember.GoogleIapWebIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleIapWebIamMember.GoogleIapWebIamMemberConfig",
