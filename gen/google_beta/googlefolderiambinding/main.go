...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFolderIamBinding.GoogleFolderIamBindingCondition",
		reflect.TypeOf((*GoogleFolderIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleFolderIamBinding.GoogleFolderIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFolderIamBinding.GoogleFolderIamBindingConfig",
