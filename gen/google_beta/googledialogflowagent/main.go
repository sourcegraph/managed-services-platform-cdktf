...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDialogflowAgent.GoogleDialogflowAgentConfig",
		reflect.TypeOf((*GoogleDialogflowAgentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDialogflowAgent.GoogleDialogflowAgentTimeouts",
		reflect.TypeOf((*GoogleDialogflowAgentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleDialogflowAgent.GoogleDialogflowAgentTimeoutsOutputReference",
