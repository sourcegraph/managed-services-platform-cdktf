...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceAccountIamMember.GoogleServiceAccountIamMemberCondition",
		reflect.TypeOf((*GoogleServiceAccountIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleServiceAccountIamMember.GoogleServiceAccountIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceAccountIamMember.GoogleServiceAccountIamMemberConfig",
