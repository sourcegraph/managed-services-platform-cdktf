...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeRegionTargetHttpProxy.GoogleComputeRegionTargetHttpProxy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeRegionTargetHttpProxy.GoogleComputeRegionTargetHttpProxyConfig",
		reflect.TypeOf((*GoogleComputeRegionTargetHttpProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeRegionTargetHttpProxy.GoogleComputeRegionTargetHttpProxyTimeouts",
		reflect.TypeOf((*GoogleComputeRegionTargetHttpProxyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeRegionTargetHttpProxy.GoogleComputeRegionTargetHttpProxyTimeoutsOutputReference",
