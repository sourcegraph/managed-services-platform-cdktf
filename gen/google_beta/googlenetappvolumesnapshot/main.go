...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshot",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshotConfig",
		reflect.TypeOf((*GoogleNetappVolumeSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshotTimeouts",
		reflect.TypeOf((*GoogleNetappVolumeSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshotTimeoutsOutputReference",
