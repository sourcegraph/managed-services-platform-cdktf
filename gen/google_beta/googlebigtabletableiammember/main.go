...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableTableIamMember.GoogleBigtableTableIamMemberCondition",
		reflect.TypeOf((*GoogleBigtableTableIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigtableTableIamMember.GoogleBigtableTableIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableTableIamMember.GoogleBigtableTableIamMemberConfig",
