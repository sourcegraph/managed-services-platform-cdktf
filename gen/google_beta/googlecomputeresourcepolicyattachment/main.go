...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeResourcePolicyAttachment.GoogleComputeResourcePolicyAttachment",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeResourcePolicyAttachment.GoogleComputeResourcePolicyAttachmentConfig",
		reflect.TypeOf((*GoogleComputeResourcePolicyAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeResourcePolicyAttachment.GoogleComputeResourcePolicyAttachmentTimeouts",
		reflect.TypeOf((*GoogleComputeResourcePolicyAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeResourcePolicyAttachment.GoogleComputeResourcePolicyAttachmentTimeoutsOutputReference",
