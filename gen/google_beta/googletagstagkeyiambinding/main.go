...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingCondition",
		reflect.TypeOf((*GoogleTagsTagKeyIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingConfig",
