...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingCondition",
		reflect.TypeOf((*GoogleApiGatewayApiIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingConfig",
