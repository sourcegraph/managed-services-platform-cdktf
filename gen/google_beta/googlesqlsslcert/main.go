...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSqlSslCert.GoogleSqlSslCertConfig",
		reflect.TypeOf((*GoogleSqlSslCertConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSqlSslCert.GoogleSqlSslCertTimeouts",
		reflect.TypeOf((*GoogleSqlSslCertTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSqlSslCert.GoogleSqlSslCertTimeoutsOutputReference",
