...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGeminiReleaseChannelSetting.GoogleGeminiReleaseChannelSettingConfig",
		reflect.TypeOf((*GoogleGeminiReleaseChannelSettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGeminiReleaseChannelSetting.GoogleGeminiReleaseChannelSettingTimeouts",
		reflect.TypeOf((*GoogleGeminiReleaseChannelSettingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleGeminiReleaseChannelSetting.GoogleGeminiReleaseChannelSettingTimeoutsOutputReference",
