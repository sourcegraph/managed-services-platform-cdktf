...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberCondition",
		reflect.TypeOf((*GoogleBigqueryTableIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberConfig",
