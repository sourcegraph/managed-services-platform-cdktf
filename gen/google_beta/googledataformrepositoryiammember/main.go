...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleDataformRepositoryIamMember.GoogleDataformRepositoryIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataformRepositoryIamMember.GoogleDataformRepositoryIamMemberCondition",
		reflect.TypeOf((*GoogleDataformRepositoryIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleDataformRepositoryIamMember.GoogleDataformRepositoryIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataformRepositoryIamMember.GoogleDataformRepositoryIamMemberConfig",
