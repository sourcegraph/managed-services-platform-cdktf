...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataplexGlossary.GoogleDataplexGlossaryConfig",
		reflect.TypeOf((*GoogleDataplexGlossaryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataplexGlossary.GoogleDataplexGlossaryTimeouts",
		reflect.TypeOf((*GoogleDataplexGlossaryTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleDataplexGlossary.GoogleDataplexGlossaryTimeoutsOutputReference",
