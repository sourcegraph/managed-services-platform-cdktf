...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionConfig",
		reflect.TypeOf((*GoogleSpannerInstancePartitionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionTimeouts",
		reflect.TypeOf((*GoogleSpannerInstancePartitionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionTimeoutsOutputReference",
