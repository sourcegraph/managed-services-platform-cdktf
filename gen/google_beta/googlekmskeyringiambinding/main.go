...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingCondition",
		reflect.TypeOf((*GoogleKmsKeyRingIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingConfig",
