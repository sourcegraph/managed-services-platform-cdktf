...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamBinding.GoogleGkeHubFeatureIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamBinding.GoogleGkeHubFeatureIamBindingCondition",
		reflect.TypeOf((*GoogleGkeHubFeatureIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamBinding.GoogleGkeHubFeatureIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGkeHubFeatureIamBinding.GoogleGkeHubFeatureIamBindingConfig",
