...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleProjectIamBinding.GoogleProjectIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleProjectIamBinding.GoogleProjectIamBindingCondition",
		reflect.TypeOf((*GoogleProjectIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleProjectIamBinding.GoogleProjectIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleProjectIamBinding.GoogleProjectIamBindingConfig",
