...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleCloudiotRegistryIamBinding.GoogleCloudiotRegistryIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleCloudiotRegistryIamBinding.GoogleCloudiotRegistryIamBindingCondition",
		reflect.TypeOf((*GoogleCloudiotRegistryIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleCloudiotRegistryIamBinding.GoogleCloudiotRegistryIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleCloudiotRegistryIamBinding.GoogleCloudiotRegistryIamBindingConfig",
