...
import (
	...
	"github.com/sourcegraph/managed-services-platform-cdktf/gen/google_beta/datagooglekmssecretciphertext/internal"
)
...
func NewDataGoogleKmsSecretCiphertext(scope constructs.Construct, id *string, config *DataGoogleKmsSecretCiphertextConfig) DataGoogleKmsSecretCiphertext {
	...
	_jsii_.Create(
		"@cdktf/provider-google_beta.dataGoogleKmsSecretCiphertext.DataGoogleKmsSecretCiphertext",
