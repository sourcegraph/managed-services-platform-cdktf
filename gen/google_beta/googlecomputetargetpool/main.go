...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeTargetPool.GoogleComputeTargetPoolConfig",
		reflect.TypeOf((*GoogleComputeTargetPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeTargetPool.GoogleComputeTargetPoolTimeouts",
		reflect.TypeOf((*GoogleComputeTargetPoolTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeTargetPool.GoogleComputeTargetPoolTimeoutsOutputReference",
