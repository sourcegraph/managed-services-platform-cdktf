...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeAttachedDisk.GoogleComputeAttachedDiskConfig",
		reflect.TypeOf((*GoogleComputeAttachedDiskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeouts",
		reflect.TypeOf((*GoogleComputeAttachedDiskTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeoutsOutputReference",
