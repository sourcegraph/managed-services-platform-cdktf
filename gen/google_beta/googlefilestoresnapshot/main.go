...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFilestoreSnapshot.GoogleFilestoreSnapshotConfig",
		reflect.TypeOf((*GoogleFilestoreSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts",
		reflect.TypeOf((*GoogleFilestoreSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeoutsOutputReference",
