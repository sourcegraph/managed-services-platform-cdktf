...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleEssentialContactsContact.GoogleEssentialContactsContactConfig",
		reflect.TypeOf((*GoogleEssentialContactsContactConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleEssentialContactsContact.GoogleEssentialContactsContactTimeouts",
		reflect.TypeOf((*GoogleEssentialContactsContactTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleEssentialContactsContact.GoogleEssentialContactsContactTimeoutsOutputReference",
