...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigtableTableIamPolicy.GoogleBigtableTableIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableTableIamPolicy.GoogleBigtableTableIamPolicyConfig",
