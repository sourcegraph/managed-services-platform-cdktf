...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionConfig",
		reflect.TypeOf((*DataGoogleSecretManagerRegionalSecretVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryption",
		reflect.TypeOf((*DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryptionList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryptionOutputReference",
