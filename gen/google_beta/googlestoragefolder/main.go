...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleStorageFolder.GoogleStorageFolder",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleStorageFolder.GoogleStorageFolderConfig",
		reflect.TypeOf((*GoogleStorageFolderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleStorageFolder.GoogleStorageFolderTimeouts",
		reflect.TypeOf((*GoogleStorageFolderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleStorageFolder.GoogleStorageFolderTimeoutsOutputReference",
