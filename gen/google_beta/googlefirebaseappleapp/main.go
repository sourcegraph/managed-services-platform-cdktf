...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFirebaseAppleApp.GoogleFirebaseAppleAppConfig",
		reflect.TypeOf((*GoogleFirebaseAppleAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeouts",
		reflect.TypeOf((*GoogleFirebaseAppleAppTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeoutsOutputReference",
