...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleLoggingBillingAccountExclusion.GoogleLoggingBillingAccountExclusion",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleLoggingBillingAccountExclusion.GoogleLoggingBillingAccountExclusionConfig",
