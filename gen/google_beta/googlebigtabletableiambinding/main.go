...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigtableTableIamBinding.GoogleBigtableTableIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableTableIamBinding.GoogleBigtableTableIamBindingCondition",
		reflect.TypeOf((*GoogleBigtableTableIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleBigtableTableIamBinding.GoogleBigtableTableIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleBigtableTableIamBinding.GoogleBigtableTableIamBindingConfig",
