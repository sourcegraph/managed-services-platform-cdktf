...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyConfig",
		reflect.TypeOf((*GoogleComputeRegionSslPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyTimeouts",
		reflect.TypeOf((*GoogleComputeRegionSslPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyTimeoutsOutputReference",
