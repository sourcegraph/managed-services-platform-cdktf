...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamBinding.GoogleSpannerDatabaseIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamBinding.GoogleSpannerDatabaseIamBindingCondition",
		reflect.TypeOf((*GoogleSpannerDatabaseIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamBinding.GoogleSpannerDatabaseIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamBinding.GoogleSpannerDatabaseIamBindingConfig",
