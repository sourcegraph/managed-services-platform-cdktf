...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSccSourceIamMember.GoogleSccSourceIamMemberCondition",
		reflect.TypeOf((*GoogleSccSourceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSccSourceIamMember.GoogleSccSourceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSccSourceIamMember.GoogleSccSourceIamMemberConfig",
