...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentConfig",
		reflect.TypeOf((*GoogleApigeeEndpointAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentTimeouts",
		reflect.TypeOf((*GoogleApigeeEndpointAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentTimeoutsOutputReference",
