...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberCondition",
		reflect.TypeOf((*GoogleSpannerDatabaseIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberConfig",
