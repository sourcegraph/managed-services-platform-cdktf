...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSccSourceIamBinding.GoogleSccSourceIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSccSourceIamBinding.GoogleSccSourceIamBindingCondition",
		reflect.TypeOf((*GoogleSccSourceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSccSourceIamBinding.GoogleSccSourceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSccSourceIamBinding.GoogleSccSourceIamBindingConfig",
