...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleLustreInstance.DataGoogleLustreInstance",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleLustreInstance.DataGoogleLustreInstanceConfig",
