...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleIapWebIamBinding.GoogleIapWebIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleIapWebIamBinding.GoogleIapWebIamBindingCondition",
		reflect.TypeOf((*GoogleIapWebIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleIapWebIamBinding.GoogleIapWebIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleIapWebIamBinding.GoogleIapWebIamBindingConfig",
