...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleCloudbuildv2Repository.GoogleCloudbuildv2Repository",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleCloudbuildv2Repository.GoogleCloudbuildv2RepositoryConfig",
		reflect.TypeOf((*GoogleCloudbuildv2RepositoryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleCloudbuildv2Repository.GoogleCloudbuildv2RepositoryTimeouts",
		reflect.TypeOf((*GoogleCloudbuildv2RepositoryTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleCloudbuildv2Repository.GoogleCloudbuildv2RepositoryTimeoutsOutputReference",
