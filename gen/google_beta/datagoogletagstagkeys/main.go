...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysConfig",
		reflect.TypeOf((*DataGoogleTagsTagKeysConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeys",
		reflect.TypeOf((*DataGoogleTagsTagKeysKeys)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysOutputReference",
