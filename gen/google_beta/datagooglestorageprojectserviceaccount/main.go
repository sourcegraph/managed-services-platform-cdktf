...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleStorageProjectServiceAccount.DataGoogleStorageProjectServiceAccount",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleStorageProjectServiceAccount.DataGoogleStorageProjectServiceAccountConfig",
