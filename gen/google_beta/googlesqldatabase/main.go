...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSqlDatabase.GoogleSqlDatabaseConfig",
		reflect.TypeOf((*GoogleSqlDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleSqlDatabase.GoogleSqlDatabaseTimeouts",
		reflect.TypeOf((*GoogleSqlDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleSqlDatabase.GoogleSqlDatabaseTimeoutsOutputReference",
