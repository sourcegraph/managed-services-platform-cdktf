...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleCloudRunV2JobIamBinding.GoogleCloudRunV2JobIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleCloudRunV2JobIamBinding.GoogleCloudRunV2JobIamBindingCondition",
		reflect.TypeOf((*GoogleCloudRunV2JobIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleCloudRunV2JobIamBinding.GoogleCloudRunV2JobIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleCloudRunV2JobIamBinding.GoogleCloudRunV2JobIamBindingConfig",
