...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googlePrivatecaCaPoolIamBinding.GooglePrivatecaCaPoolIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googlePrivatecaCaPoolIamBinding.GooglePrivatecaCaPoolIamBindingCondition",
		reflect.TypeOf((*GooglePrivatecaCaPoolIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googlePrivatecaCaPoolIamBinding.GooglePrivatecaCaPoolIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googlePrivatecaCaPoolIamBinding.GooglePrivatecaCaPoolIamBindingConfig",
