...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeDiskIamBinding.GoogleComputeDiskIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeDiskIamBinding.GoogleComputeDiskIamBindingCondition",
		reflect.TypeOf((*GoogleComputeDiskIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeDiskIamBinding.GoogleComputeDiskIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeDiskIamBinding.GoogleComputeDiskIamBindingConfig",
