...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeSslPolicy.GoogleComputeSslPolicyConfig",
		reflect.TypeOf((*GoogleComputeSslPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleComputeSslPolicy.GoogleComputeSslPolicyTimeouts",
		reflect.TypeOf((*GoogleComputeSslPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleComputeSslPolicy.GoogleComputeSslPolicyTimeoutsOutputReference",
