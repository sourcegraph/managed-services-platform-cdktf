...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleServiceAccountIamBinding.GoogleServiceAccountIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition",
		reflect.TypeOf((*GoogleServiceAccountIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingConfig",
