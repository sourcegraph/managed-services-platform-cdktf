...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFirebaseWebApp.GoogleFirebaseWebAppConfig",
		reflect.TypeOf((*GoogleFirebaseWebAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleFirebaseWebApp.GoogleFirebaseWebAppTimeouts",
		reflect.TypeOf((*GoogleFirebaseWebAppTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleFirebaseWebApp.GoogleFirebaseWebAppTimeoutsOutputReference",
