...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleGeminiLoggingSetting.GoogleGeminiLoggingSetting",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingConfig",
		reflect.TypeOf((*GoogleGeminiLoggingSettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeouts",
		reflect.TypeOf((*GoogleGeminiLoggingSettingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeoutsOutputReference",
