...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleSpannerDatabase.DataGoogleSpannerDatabase",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleSpannerDatabase.DataGoogleSpannerDatabaseConfig",
		reflect.TypeOf((*DataGoogleSpannerDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.dataGoogleSpannerDatabase.DataGoogleSpannerDatabaseEncryptionConfig",
		reflect.TypeOf((*DataGoogleSpannerDatabaseEncryptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleSpannerDatabase.DataGoogleSpannerDatabaseEncryptionConfigList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.dataGoogleSpannerDatabase.DataGoogleSpannerDatabaseEncryptionConfigOutputReference",
