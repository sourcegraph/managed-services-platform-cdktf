...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlConfig",
		reflect.TypeOf((*GoogleStorageBucketAccessControlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlTimeouts",
		reflect.TypeOf((*GoogleStorageBucketAccessControlTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlTimeoutsOutputReference",
