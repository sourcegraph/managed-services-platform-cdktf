...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleDataprocJobIamMember.GoogleDataprocJobIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberCondition",
		reflect.TypeOf((*GoogleDataprocJobIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberConfig",
