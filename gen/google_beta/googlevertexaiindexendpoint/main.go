...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleVertexAiIndexEndpoint.GoogleVertexAiIndexEndpointConfig",
		reflect.TypeOf((*GoogleVertexAiIndexEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleVertexAiIndexEndpoint.GoogleVertexAiIndexEndpointPrivateServiceConnectConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google_beta.googleVertexAiIndexEndpoint.GoogleVertexAiIndexEndpointTimeouts",
		reflect.TypeOf((*GoogleVertexAiIndexEndpointTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google_beta.googleVertexAiIndexEndpoint.GoogleVertexAiIndexEndpointTimeoutsOutputReference",
