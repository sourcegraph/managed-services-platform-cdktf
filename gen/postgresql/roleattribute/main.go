...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "extensionAttrs", GoGetter: "ExtensionAttrs"},
			_jsii_.MemberProperty{JsiiProperty: "extensionAttrsInput", GoGetter: "ExtensionAttrsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExtensionAttrs", GoMethod: "ResetExtensionAttrs"},
