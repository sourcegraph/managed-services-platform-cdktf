...
type SubscriptionConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sourcegraph/postgresql/1.25.0-sg.4/docs/resources/subscription#name Subscription#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// Names of the publications on the publisher to subscribe to.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sourcegraph/postgresql/1.25.0-sg.4/docs/resources/subscription#publications Subscription#publications}
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sourcegraph/postgresql/1.25.0-sg.4/docs/resources/subscription#id Subscription#id}.
	//
